  ...
  head: () => ({
    meta: [
      ...
      { title: "Vansh Mandrawadker — Product Designer" },
      {
        name: "description",
        content:
          "Freelance Product Designer specialising in branding, UI/UX, and industrial design.",
      },
    ...
    links: [
      ...
      {
        rel: "icon",
        href: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' fill='%230C0C0D'/%3E%3Ctext x='16' y='23' font-family='Arial,sans-serif' font-size='20' font-weight='800' fill='%23FF2B2B' text-anchor='middle'%3EV%3C/text%3E%3C/svg%3E",
      },
    ],
  }),
